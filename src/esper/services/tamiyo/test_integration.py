...
from esper.services.tamiyo import IntelligentRewardComputer
from esper.services.tamiyo import Phase2IntegrationOrchestrator
from esper.services.tamiyo import ProductionHealthCollector
from esper.services.tamiyo import ProductionPolicyTrainer
...
class IntegrationTester:
    ...
    async def test_policy_trainer(self) -> bool:
        ...
        try:
            ...
            from esper.services.tamiyo import TamiyoPolicyGNN
