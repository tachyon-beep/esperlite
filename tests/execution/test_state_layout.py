...
import pytest
import torch
from esper.execution.state_layout import KasminaStateLayout, SeedLifecycleState
...
class TestKasminaStateLayout:
    ...
    def test_initialization(self):
        ...
        assert torch.allclose(layout.health_accumulator, torch.zeros_like(layout.health_accumulator))
    ...
    def test_update_telemetry(self):
        ...
        assert abs(layout.health_accumulator[0].item() - 0.8) < 0.01  # First update, no smoothing
