...
class TestTolariaTrainer:
    ...
    def test_scheduler_setup(self, minimal_config):
        ...
        trainer.optimizer = torch.optim.Adam(
            [dummy_param], lr=0.01, weight_decay=0.0001
        )
...
class TestTolariaService:
    ...
    def test_health_check(self, mock_trainer_class, minimal_config):
        ...
        mock_trainer_instance.get_training_state.return_value = TrainingState(
            epoch=5, total_adaptations=2, best_val_accuracy=0.85
        )
...
class TestFullSystemIntegration:
    ...
    async def test_complete_training_cycle(
        self, mock_initialize, mock_train, minimal_config
    ):
    ...
    async def test_graceful_shutdown_on_signal(
        self, mock_setup_data, mock_train, minimal_config
    ):
...
class TestConfigurationValidation:
    ...
    def test_config_from_yaml(self, temp_config_dir):
        ...
        config_data = {
            ...
            "dataset": {"name": "cifar10", "data_dir": "/tmp"},
            "optimizer": "adam",
        }
