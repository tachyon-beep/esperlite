...
from src.esper.morphogenetic_v2.message_bus.handlers import BatchCommandProcessor
from src.esper.morphogenetic_v2.message_bus.handlers import BlueprintUpdateProcessor
from src.esper.morphogenetic_v2.message_bus.handlers import CommandContext
from src.esper.morphogenetic_v2.message_bus.handlers import CommandHandler
from src.esper.morphogenetic_v2.message_bus.handlers import CommandHandlerFactory
from src.esper.morphogenetic_v2.message_bus.handlers import CommandPriority
from src.esper.morphogenetic_v2.message_bus.handlers import CommandResult
from src.esper.morphogenetic_v2.message_bus.handlers import EmergencyStopProcessor
from src.esper.morphogenetic_v2.message_bus.handlers import LifecycleTransitionProcessor
from src.esper.morphogenetic_v2.message_bus.schemas import BatchCommand
from src.esper.morphogenetic_v2.message_bus.schemas import BlueprintUpdateCommand
from src.esper.morphogenetic_v2.message_bus.schemas import EmergencyStopCommand
...
class TestEmergencyStopProcessor:
    ...
    def processor(self, mock_layer):
        """Create processor with mock layer."""
        layer2 = Mock()
        layer2.emergency_stop = AsyncMock()
        layer_registry = {
            "layer1": mock_layer,
            "layer2": layer2
        }
    ...
    async def test_execute_fallback_to_dormant(self, processor):
        ...
        # Layer without emergency_stop method - use spec to prevent auto-vivification
        basic_layer = Mock(spec=['num_seeds', 'set_seed_state'])
...
class TestCommandHandler:
    ...
    async def test_start_stop(self, handler):
        ...
        await handler.stop()
        assert not handler._running
        assert handler._processor_task.cancelled()
