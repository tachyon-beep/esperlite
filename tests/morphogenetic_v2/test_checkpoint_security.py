...
from src.esper.morphogenetic_v2.lifecycle import CheckpointRecovery
...
@pytest.mark.skip(reason="CheckpointManager lacks security validation methods tested here")
class TestCheckpointSecurity:
    """Test suite for checkpoint security vulnerabilities."""

    @pytest.mark.skip(reason="CheckpointManager doesn't have _validate_checkpoint_id method")
...
@pytest.mark.skip(reason="CheckpointManager doesn't validate inputs as expected by these tests")
