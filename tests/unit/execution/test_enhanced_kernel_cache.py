...
from src.esper.contracts.assets import KernelMetadata, CompiledKernel
from src.esper.execution.enhanced_kernel_cache import (
    EnhancedKernelCache,
    KernelValidator
)
...
class TestEnhancedKernelCache:
    ...
    def create_test_metadata(self, kernel_id="test_kernel", input_shape=[10], output_shape=[5]):
    ...
    async def test_find_compatible_kernels(self):
        ...
        self.cache._add_to_cache_with_metadata("compatible1", test_tensor, compatible_metadata1)
        self.cache._add_to_cache_with_metadata("compatible2", test_tensor, compatible_metadata2)
        self.cache._add_to_cache_with_metadata("incompatible", test_tensor, incompatible_metadata)
    ...
    def test_get_kernel_metadata(self):
        ...
        self.cache._add_to_cache_with_metadata("test_kernel", test_tensor, test_metadata)
